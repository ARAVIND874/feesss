...
document.getElementById("printBill").addEventListener("click", function() {
    ...
    printWindow.document.write(`         
        ...
        <head>             
            <title>Bill Receipt</title>             
            <style>                 
                body { font-family: 'Poppins', sans-serif; text-align: center; background: #f4f7fc; margin: 0; padding: 0; }                 
                .receipt-container { width: 90%; max-width: 400px; margin: auto; padding: 20px; background: white; border-radius: 12px; box-shadow: 0px 4px 20px rgba(0, 0, 0, 0.2); border: 3px solid #6a11cb; text-align: left; }                 
